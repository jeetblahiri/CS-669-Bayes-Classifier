# -*- coding: utf-8 -*-
"""Group 13_A1_RD_Final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1iLK5r0KzBmTKn8j8MS9kabRcFFabL_0-
...
data_class1 = np.load('/content/drive/MyDrive/Group13/rd_group13/class1_train.npy')
data_class2 = np.load('/content/drive/MyDrive/Group13/rd_group13/class2_train.npy')
data_class3 = np.load('/content/drive/MyDrive/Group13/rd_group13/class3_train.npy')
data_test1   = np.load('/content/drive/MyDrive/Group13/rd_group13/class1_train.npy')
data_test2   = np.load('/content/drive/MyDrive/Group13/rd_group13/class2_train.npy')
data_test3   = np.load('/content/drive/MyDrive/Group13/rd_group13/class3_train.npy')
data = []
...
data = []
for i in np.arange(minx,maxx,4):
    for j in np.arange(miny,maxy,4):
        data.append([i,j])
data = np.array(data)
print(data.shape[0])
